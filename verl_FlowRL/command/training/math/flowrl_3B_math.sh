...
project_name='FlowRL'
exp_name="FlowRL-cispo-clip-AlphaGFN-${alphagfn_alpha}-Qwen2.5-3B-$(date +'%Y%m%d-%H%M')"
...
dapo_train_path="/mnt/shared-storage-user/chenlin1/FlowRL/data/math_data/dapo-math-17k.parquet"
r1_test_path="/mnt/shared-storage-user/chenlin1/FlowRL/data/math_data/validation.parquet"


max_prompt_length=2048
max_response_length=8192
OUTPUT_DIR="/mnt/shared-storage-user/formalverification-shared/chenlin1/verl/ckpts/${project_name}/${exp_name}"
